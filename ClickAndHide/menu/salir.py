...
def show_salir_panel(screen):
    """
    Muestra un panel de confirmación para salir del juego
    """
    ...
    while running:
        ...
        title = big_font.render("¿Salir del juego?", True, (0, 0, 0))
        ...
        txt_yes = font.render("Sí", True, (0, 0, 0))
